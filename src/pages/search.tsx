...
export default function Page() {
  return (
    <Layout>
      <SidebarTrigger />
      <main className="flex flex-col w-full max-w-[500px] mx-auto min-h-screen flex-grow">
        <Card className="flex flex-col w-full items-center justify-start flex-grow">
          {/* Header */}
